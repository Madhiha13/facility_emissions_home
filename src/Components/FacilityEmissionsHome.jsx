...
import {cart10,cart11,cart12,cart2,left,user,vector11,vector12,vector13} from "./../Assets"
...
const FacilityEmissionsHome = () => {
  ...
  const onContentClick = useCallback(() => {
    // Please sync "Stationary Combustion - List" to the project
  }, []);

  const onContentClick1 = useCallback(() => {
    // Please sync "Mobile Combustion - List" to the project
  }, []);

  const onContentClick2 = useCallback(() => {
    // Please sync "Fugitive Emissions - List" to the project
  }, []);

  const onContentClick3 = useCallback(() => {
    // Please sync "Process Emissions - List" to the project
  }, []);
  const yearRanges = [
    '2022-2023',
    '2021-2022',
              ...
              <div className="frame-group">
                ...
                <div className="frame-parent2">
                  ...
                  <div className="frame-parent9">
                    <div className="content-parent8">
                      <div className="content131" onClick={onContentClick1} />
                ...
                <div className="frame-parent20">
                  <div className="frame-parent21">
                    ...
                    <div className="content-parent22">
                      <div className="content266" onClick={onContentClick2} />
